...
The framework provides code generation and build system by command line interface for efficient development.
...
We give discussions for internal design of publish/subscribe transport for ROS-lite.
