...
%%%%%%%%%%%% 概要 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
  This paper presents evaluations of parallel computing and software development framework called ROS-lite for NoC-based embedded many-core platforms.
  ...
  Additionally, the proposed framework provides the structured communications layer on NoC components with few memory consumption and efficient software development for embedded many-core platforms.
  We investigate currently achievable data transfer latencies between distributed memories on NoC components, memory access characteristics with NUMA, and parallelization scalability of many cores.
  ...
  By highlighting many-core computing capabilities and efficient software development, we explore scalable parallel computing on NoC-based embedded many-core platforms.
\end{abstract}
